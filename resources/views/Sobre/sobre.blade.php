...
<section class="bg-white dark:bg-gray-900">
  <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
      <div class="mx-auto mb-8 max-w-screen-sm lg:mb-16">
          ...
          <p class="font-light text-gray-500 sm:text-xl dark:text-gray-400">"Conheça nosso time de desenvolvedores altamente qualificados e experientes, trabalhando juntos para criar soluções inovadoras e personalizadas para atender às suas necessidades de tecnologia."
...
<blockquote class="text-xl italic font-semibold text-gray-900 dark:text-white text-center">
    ...
    <p>"Conte sempre com nosso time de desenvolvedores para encontrar as melhores soluções em tecnologia e levar o seu negócio ao próximo nível."</p>
</blockquote>
