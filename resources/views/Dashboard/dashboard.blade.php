...
<section class="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5">
    <h1 class="text-5xl font-extrabold dark:text-white max-w-screen-xl mx-auto text-center my-8">Produtos<small
            class="ml-2 font-semibold text-gray-500 dark:text-gray-400">registrados por você:</small></h1>
        ...
        <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
            <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                ...
                <div
                    ...
                    <a href="{{ route('produto.create') }}">
                        <button type="button"
                            class="flex items-center justify-center  bg-primary-700 hover:bg-primary-800  focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700  dark:focus:ring-primary-800
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        @foreach ($registros['produtos'] as $produtos)
                        <tr class="border-b dark:border-gray-700">
                            <th scope="row"
                                class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                {{ $produtos['nome'] }}</th>
                            <td class="px-4 py-3">{{ $produtos['categoria']['nome'] }}</td>
                            <td class="px-4 py-3">{{ $produtos['marca'] }}</td>
                            <td class="px-4 py-3">{{ $produtos['descricao'] }}</td>
                            <td class="px-4 py-3">R$ {{ $produtos['valor'] }}</td>
                            <td class="px-4 py-3 flex items-center justify-end">
                                <button id="playstation-5-dropdown-button" data-dropdown-toggle="{{ $produtos['categoria']['nome'] }}"
                                ...
                                <div id="{{ $produtos['categoria']['nome'] }}"
                                    class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                                    <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                                    ...
                                    <div class="py-1">
                                        <form action="{{ route('produto.destroy',$produtos['id']) }}" method="POST">
                                            ...
                                            @method('DELETE')
                                            <button
                                                class="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Apagar</button>
                                        </form>
...
<section class="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5">
    <h1 class="text-5xl font-extrabold dark:text-white max-w-screen-xl mx-auto text-center my-8">Serviços<small
            class="ml-2 font-semibold text-gray-500 dark:text-gray-400">registrados por você:</small></h1>
    <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
                ...
                <div
                   ...
                   <a href="{{ route('servico.create') }}">
                    ...
                    <div class="flex items-center space-x-3 w-full md:w-auto">
                        ...
                        <button id="filterDropdownButton" data-dropdown-toggle="servicoDropDown"
                            class="w-full md:w-auto flex items-center justify-center py-2 px-4 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700"
                            type="button">
                            <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true"
                                class="h-4 w-4 mr-2 text-gray-400" viewbox="0 0 20 20" fill="currentColor">
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        ...
                        @foreach ($registros['servicos'] as $servicos)
                        ...
                        <tr class="border-b dark:border-gray-700">
                            <th scope="row"
                                class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                {{ $servicos['nome'] }}</th>
                            <td class="px-4 py-3">{{ $servicos['categoria']['nome'] }}</td>
                            <td class="px-4 py-3">XXX</td>
                            <td class="px-4 py-3">{{ $servicos['descricao'] }}</td>
                            <td class="px-4 py-3">R$ {{ $servicos['valor'] }}</td>
                            <td class="px-4 py-3 flex items-center justify-end">
                                <button id="playstation-5-dropdown-button" data-dropdown-toggle="{{ $servicos['categoria']['nome'] }}"
                                    class="inline-flex items-center p-0.5 text-sm font-medium text-center text-gray-500 hover:text-gray-800 rounded-lg focus:outline-none dark:text-gray-400 dark:hover:text-gray-100"
                                    type="button">
                                    <svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewbox="0 0 20 20"
                                        xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div id="{{ $servicos['categoria']['nome'] }}"
                                    class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                                    <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                                        aria-labelledby="playstation-5-dropdown-button">
                                        <li>
