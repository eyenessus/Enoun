    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg mx-auto">
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400 mx-auto">
            ...
            <tfoot>
                <tr class="font-semibold text-gray-900 dark:text-white ">
                    ...
                    <td>R$ {{number_format($totalProdutos+$totalServicos - (($totalProdutos+$totalServicos)*$cupom/100), 2, ',', '.')}}</td>
        ...
        <div class="mx-8 my-8 ">
            <label class="block">
                ...
                <input type="text" name="cupom" id="cupom" class="w-75  mt-1 px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block rounded-md sm:text-sm focus:ring-1" placeholder="EXEMPLO19" value="{{ auth()->user()->cupons()->first()->codigoResgate ?? old('cupom')}}" />
                <div id="situacaoCupom" role="alert">
                </div>
                <button type="button" id="botaoVerificarCupom" class=" my-2 mx-2 text-white bg-green-700 hover:bg-green-800 focus:outline-none focus:ring-4 focus:ring-green-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Aplicar cupom</button>
              </label>
        </div>
            ...
            <div class="p-6 space-y-6">
                ...
                <div class="relative overflow-x-auto">
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tfoot>
                            <tr class="font-semibold text-green-400 dark:text-white">
                                <th scope="row" class="px-6 py-3 text-base">Desconto de {{ $cupom }}%</th>
                            </tr>
                            <tr class="font-semibold text-gray-900 dark:text-white">
                                <th scope="row" class="px-6 py-3 text-base">Total</th>
                                <td class="px-6 py-3">
                                ...
                                <td class="px-6 py-3">R$ {{number_format($totalProdutos+$totalServicos - (($totalProdutos+$totalServicos)*$cupom/100), 2, ',', '.')}}
                                </td>
