...
<div class="containe mx-auto max-w-screen-xl">
    <form method="POST" action="{{ route('identidade.store') }}" id="formIdentidade">
        @csrf
        <div class="mb-6">
        ...
        <div class="mb-6">
            <label for="documento" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Número do
                documento</label>
        ...
        <div class="mb-6">
            <label for="codigo_area" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Código de
                área</label>
        ...
        <button type="submit" id="botaoCadastroIdentidade" class="float-right text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Próximo</button>
