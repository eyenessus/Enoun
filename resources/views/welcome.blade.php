...
<section class="bg-white dark:bg-gray-900">
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
        ...
        <div class="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
            ...
            @if($value['status'] == "active" && $value['auto_recurring']['transaction_amount'] >= 100.0)
            <div
                class="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
                <h3 class="mb-4 text-2xl font-semibold">{{ $value['reason'] }}</h3>
                ...
                <div class="flex justify-center items-baseline my-8">
                    <span class="mr-2 text-5xl font-extrabold"> R${{
                        number_format($value['auto_recurring']['transaction_amount'], 2, '.', '') }}</span>
                ...
                <ul role="list" class="mb-8 space-y-4 text-left">
                    ...
                    <form action="{{ route('assinarPlano',$value['id']) }}" method="post">
                        @csrf
                        <button
                        type="submit"
