    ...
    <div class="container">
        ...
        <form method="POST" action="{{ route('saveservice') }}" enctype="multipart/form-data"
            ...
            <div class="mb-3">
                ...
                <input type="tel  " class="form-control" id="preco" name="preco" placeholder="Preço do serviço"
                    required>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3 form-check">
                <input type="checkbox" class="form-check-input" id="atendimento" value="Atendimento Prioritário"
                    name="inforextra[]">
