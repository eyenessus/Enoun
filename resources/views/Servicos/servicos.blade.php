...
<section class="bg-white dark:bg-gray-900">
    <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
        <div class="max-w-screen-md">
            <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Solucione suas demandas tecnológicas com nossos serviços completos em informática e suporte remoto!</h2>
            <p class="mb-8 font-light text-gray-500 sm:text-xl dark:text-gray-400">Tenha soluções completas em serviços de informática, desde impressões até suporte remoto via TeamViewer, tudo isso com expertise em sistemas operacionais Windows e Linux para atender todas as suas necessidades tecnológicas.</p>
...
<div class="container mx-auto px-5 p-5 dark:bg-slate-900">
    <h1 class="text-3xl text-bold dark:text-white">Serviços de informática</h1>
    ...
    <h1 class="text-3xl text-bold dark:text-white">Impressões</h1>
    <div class="grid grid-cols-1 md:grid-cols-5 sm:grid-cols-2 gap-5 pt-5">
