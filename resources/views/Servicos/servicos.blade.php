    ...
    <div>
        <div class="container  px-5 p-5 dark:bg-slate-900 mx-auto ">
            <div class="container px-5 p-5 dark:bg-slate-900 rounded ">
                <h1 class="text-3xl text-bold dark:text-white">Eletronicos</h1>
                <div class="grid grid-cols-1 md:grid-cols-5 xl:grid-cols-4 sm:grid-cols-2 gap-5 pt-5 rounded  ">


                    @foreach (servico as servicos)
                        @if (servicos->categoria->nome == 'Eletronico')
                            <div>
                                <div
                                    ...
                                    <div class="px-5 pb-5 mb-5">
                                        ...
                                        <div class="flex items-center justify-between pt-5">
                                            <div class="ml-auto">
                                                <a href="{{ servicos->id }}" class="text-white bg-green-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-blue-800">Comprar</a>
                                            </div>
