                        ...
                        @if($produtos->categoria->nome == $categorias->nome)
                            <div>
                                <div class="w-full max-w-sm bg-white border border-gray-200  shadow dark:bg-slate-600 dark:border-gray-700 rounded">
                                    <a href="#">
                                        <img class="p-3 rounded-t-lg" src="/storage/{{ $produtos->imagem }}" alt="{{ $produtos->nome }}" />
                                    </a>
                                    <div class="px-5 pb-5 mb-5">
                                        <a href="#">
                                            <h5 class="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">{{ $produtos->nome }}</h5>
                                        </a>
                                        <div class="flex items-center justify-between pt-5">
                                            <span class="text-3xl font-bold text-gray-900 dark:text-white">R${{ $produtos->valor }},00</span>
                                        </div>
                                        <div class="flex items-center justify-between pt-5">
